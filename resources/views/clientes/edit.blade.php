                ...
                <div class="card-body">
                    <form method="POST" action="{{route('clientes.update',$cliente->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="rut_cliente" name="rut_cliente" class="form-control" value="{{$cliente->rut_cliente}}">
                        </div>
                        <div class="form-group">
                            <label for="nombreClie">Nombre Cliente:</label>
                            <input type="text" id="nombreClie" name="nombreClie" class="form-control" value="{{$cliente->nombreClie}}">
                        </div>
                        <div class="form-group">
                            <label for="apellidoClie">Apellido Cliente:</label>
                            <input type="text" id="apellidoClie" name="apellidoClie" class="form-control" value="{{$cliente->apellidoClie}}">
                        </div>
                        <div class="form-group">
                            <label for="direccionClie">Direccion Cliente:</label>
                            <input type="text" id="direccionClie" name="direccionClie" class="form-control" min="1" max="99" value="{{$cliente->direccionClie}}">
                        </div>
                        <div class="form-group">
                            <label for="emailClie">Email Cliente:</label>
                            <input type="text" id="emailClie" name="emailClie" class="form-control" value="{{$cliente->emailClie}}">
                        </div>
                        <div class="form-group">
                            <label for="telefonoClie">Telefono Cliente:</label>
                            <input type="text" id="telefonoClie" name="telefonoClie" class="form-control" value="{{$cliente->telefonoClie}}">
                        </div>
