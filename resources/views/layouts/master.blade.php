        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #5722e9">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item @if(Route::current()->getName()!='home.index' && Request::segments()[0]=='compras') active @endif">
              ...
              <li class="nav-item @if(Route::current()->getName()!='home.index' && Request::segments()[0]=='ajustes') active @endif">
                <a class="nav-link" href="{{route('ajustes.index')}}">Ajustar Stock</a>
              </li>
